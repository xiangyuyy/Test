...
<body>
		...
		<div class="layui-container">
			...
			<ul class="layui-nav">
				<li class="layui-nav-item layui-hide-xs"><a
					href="//www.layui.com/doc/">文档</a></li>
				<li class="layui-nav-item layui-hide-xs"><a
					href="//www.layui.com/demo/">示例</a></li>
				<li class="layui-nav-item layui-hide-xs "><a href="/extend/">扩展</a>
				</li>
				<li class="layui-nav-item layui-hide-xs layui-this"><a
					href="/store/">模板<span class="layui-badge-dot"></span></a></li>
				...
				<li class="layui-nav-item"><a href="javascript:;">周边</a>
					<dl class="layui-nav-child">
						<dd class="layui-hide-sm layui-show-xs" lay-unselect>
							<a href="//fly.layui.com/store/">模板市场</a>
						</dd>
						<dd class="layui-hide-sm layui-show-xs" lay-unselect>
							<a href="//fly.layui.com/extend/">扩展组件</a>
						</dd>
						<dd class="layui-hide-sm layui-show-xs" lay-unselect>
						...
						<dd lay-unselect>
							<a href="//www.layui.com/admin/" target="_blank">后台模板<span
								class="layui-badge-dot"></span></a>
						</dd>
						<dd lay-unselect>
							<a href="//www.layui.com/layim/" target="_blank">即时聊天</a>
							<hr>
						</dd>
						<dd lay-unselect>
	...
	<div class="shop-nav shop-index">
		...
		<div class="shop-banner">
			...
			<div class="layui-carousel" lay-filter="LAY-store-banner"
				id="LAY-store-banner" style="background: #F2E6D6">
				<div carousel-item>
					...
					<div style="background: #F5F5F5">
						<div class="layui-container">
							<a href="/store/layuiCateCompany/" target="_blank"> <img
					src="../one.jpg"
								alt="餐饮企业网站模板">
							</a>
						</div>
					...
					<div style="background: #E2DEF5">
						<div class="layui-container">
							<a href="/store/layuiMaternalBabyMall/" target="_blank"> <img
									src="../two.jpg"
								alt="母婴商城模板">
							</a>
						</div>
					...
					<div style="background: #040227">
						<div class="layui-container">
							<a href="/store/layuiSimpleBlog/" target="_blank"> <img
				src="../one.jpg"
								alt="极简博客模板">
							</a>
						</div>
	...
	<div class="shop-temp">
		...
		<div class="temp-normal">
			<div class="layui-container">
				<p class="temp-title-cn">
					<span></span> <a href="/store/cat/0/">最新模板</a> <span></span>
				</p>
				<div class="layui-row layui-col-space20 shoplist">
					...
					<div
						class="layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg3">
						<a class="template store-list-box"
							href="/store/layuiMaternalBabyMall/"> <img
							src="http://cdn.layui.com/upload/2018_11/168_1541605166076_26629.jpg"
							class="store-list-cover">
							<h2 class="layui-elip">母婴商城模版</h2>
							<div>
								<label class="layui-badge-rim">免费</label>
								<div class="store-list-colorbar" title="紫色调">
									<span class="store-color-bar" style="background: #813bd9"></span>
								</div>
							</div>
						</a>
					</div>
					<div
						class="layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg3">
						<a class="template store-list-box" href="/store/layuiSimpleBlog/">
							<img
							src="http://cdn.layui.com/upload/2018_11/168_1541594387829_21849.jpg"
							class="store-list-cover">
					...
					<div
						...
						<a class="template store-list-box" href="/store/layuiQuietBlog/">
							...
							<h2 class="layui-elip">静谧风格个人博客模板</h2>
							<div>
								<label class="layui-badge-rim store-list-pay"> ￥68 </label>
								<div class="store-list-colorbar" title="黑色调">
									<span class="store-color-bar" style="background: #000"></span>
								</div>
							</div>
					...
					<div
						class="layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg3">
						<a class="template store-list-box" href="/store/layuiXianyan/">
							<img
							src="http://cdn.layui.com/upload/2018_11/168_1541587884233_39873.jpg"
							class="store-list-cover">
							<h2 class="layui-elip">闲言轻博客模板</h2>
							<div>
								<label class="layui-badge-rim">免费</label>
								<div class="store-list-colorbar" title="蓝色调">
									<span class="store-color-bar" style="background: #1E9FFF"></span>
					...
					<div
						class="layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg3">
						<a class="template store-list-box" href="/store/FlyTemplate/">
							<img
							src="http://cdn.layui.com/upload/2018_11/168_1541584083687_58443.jpg"
							class="store-list-cover">
							<h2 class="layui-elip">Fly社区 - layui 官方社区模版</h2>
							<div>
								<label class="layui-badge-rim">免费</label>
								<div class="store-list-colorbar" title="黑色调">
									<span class="store-color-bar" style="background: #000"></span>
					...
					<div
						...
						<a class="template store-list-box" href="/store/layuiSimpleNews/">
							...
							<h2 class="layui-elip">极简自媒体新闻资讯模板</h2>
							<div>
								<label class="layui-badge-rim store-list-pay"> ￥150 </label>
								<div class="store-list-colorbar" title="蓝色调">
									<span class="store-color-bar" style="background: #1E9FFF"></span>
								</div>
							</div>
					...
					<div
						class="layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg3">
						<a class="template store-list-box" href="/store/layuiHomeMall/">
							<img
							src="http://cdn.layui.com/upload/2018_11/168_1541547672289_84484.jpg"
							class="store-list-cover">
							<h2 class="layui-elip">简约家居商城模板</h2>
							<div>
								<label class="layui-badge-rim store-list-pay"> ￥200 </label>
								<div class="store-list-colorbar" title="棕色调">
									<span class="store-color-bar" style="background: #794712"></span>
								</div>
							</div>
						</a>
					</div>
					<div
						...
						<a class="template store-list-box" href="/store/layuiAdmin/">
							<img
							src="http://cdn.layui.com/upload/2018_11/168_1541542262728_21622.jpg"
							class="store-list-cover">
							<h2 class="layui-elip">layuiAdmin 通用后台管理模板</h2>
							<div>
								<label class="layui-badge-rim store-list-pay"> 收费 </label>
								<div class="store-list-colorbar" title="任意色调">
									<img
										src="http://cdn.layui.com/upload/2018_11/168_1541355296795_60368.jpg"
										class="store-color-bar">
								</div>
							</div>
						</a>
					</div>
					<div
						...
						<a class="template store-list-box" href="/store/layim/"> <img
							...
							<h2 class="layui-elip">LayIM 网页即时通讯前端解决方案</h2>
							<div>
								<label class="layui-badge-rim store-list-pay"> ￥600 </label>
								<div class="store-list-colorbar" title="灰色调">
									<span class="store-color-bar" style="background: #e6e6e6"></span>
								</div>
							</div>
						</a>
					</div>
