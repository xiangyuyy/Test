  ...
  <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
      <label class="layui-form-label">快速的价格</label>
      <div class="layui-input-inline">
        <input type="text" name="fastprice" value="${good.fastprice!}" lay-verify="required|littlenumber" placeholder="快速的价格" autocomplete="off" class="layui-input">
      </div>
    </div>
            <div class="layui-form-item">
      <label class="layui-form-label">慢速的价格</label>
      <div class="layui-input-inline">
        <input type="text" name="slowprice" value="${good.slowprice!}" lay-verify="required|littlenumber" placeholder="慢速的价格" autocomplete="off" class="layui-input">
      </div>
                  <div class="layui-form-item">
      <label class="layui-form-label">拿货快速的价格</label>
      <div class="layui-input-inline">
        <input type="text" name="thirdfastprice" value="${good.thirdfastprice!}" lay-verify="required|littlenumber" placeholder="拿货快速的价格" autocomplete="off" class="layui-input">
      </div>
                  <div class="layui-form-item">
      <label class="layui-form-label">拿货慢速的价格</label>
      <div class="layui-input-inline">
        <input type="text" name="thirdslowprice" value="${good.thirdslowprice!}" lay-verify="required|littlenumber" placeholder="拿货慢速的价格" autocomplete="off" class="layui-input">
      </div>
    </div>
        <div class="layui-form-item">
